...
public final class ForgetSkillTrigger implements ICriterionTrigger<ForgetSkillTrigger.Instance> {
	...
	@Override
	public void addListener(PlayerAdvancements playerAdvancements, Listener<ForgetSkillTrigger.Instance> listener) {
	...
	@Override
	public void removeListener(PlayerAdvancements playerAdvancements, Listener<ForgetSkillTrigger.Instance> listener) {
		Listeners playerListeners = this.listeners.get(playerAdvancements);
		if (playerListeners != null) {
